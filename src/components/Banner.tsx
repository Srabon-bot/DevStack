        ...
        <div className='container mx-auto px-4'>
            <div className="flex flex-col lg:flex-row items-center justify-between container mx-auto py-12 gap-10">
                <div className="text-center lg:text-left">
                    <h1 className='text-[36px] sm:text-[48px] lg:text-[60px] font-extrabold m-0 leading-tight lg:leading-none'>
                        Build Your Ideal
                    </h1>
                    <Gradient
                        as={'h1'}
                        variant='text'
                        className='text-[36px] sm:text-[48px] lg:text-[60px] font-extrabold m-0 mt-1 leading-tight lg:leading-none'
                    >
                        Development Stack
                    </Gradient>
                    ...
                    <div className="flex gap-3 mt-10 justify-center lg:justify-start">
                        ...
                        <button className="btn rounded-lg flex-1 sm:flex-none sm:w-52 text-[#374151]">
                            Learn More
                        </button>
                    </div>
                </div>
